...
var foodApp = function () {
  ...
  var renderDetailView = function renderDetailView(e) {
    if (e.target.nodeName === 'IMG') {
      var name = e.target.parentElement.nextElementSibling.lastElementChild.firstElementChild.dataset.name;
      var category = e.target.parentElement.nextElementSibling.lastElementChild.firstElementChild.dataset.category;
